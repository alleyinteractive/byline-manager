...
function get_asset_dependencies( $asset ) {
	return Byline_Manager\get_asset_dependencies( $asset );
}
...
function get_asset_hash( $asset ) {
	return Byline_Manager\get_asset_hash( $asset );
}
...
function get_asset_path( $asset, $dir = false ) {
	return Byline_Manager\get_asset_path( $asset, $dir );
}
...
function inline_locale_data( $to_handle ) {
	Byline_Manager\inline_locale_data( $to_handle );
}
